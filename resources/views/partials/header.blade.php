        ...
        <div class="header-inner flex items-center justify-between lg:justify-start">
            ...
            <div class="header-menu grow hidden lg:flex items-center ml-8 mr-8 gap-8">
                ...
                <nav class="hidden 2xl:flex gap-8">
                    ...
                    <a href="{{ route('cart.index') }}" class="text-white hover:text-pink font-bold">Корзина</a>
                </nav>
            </div><!-- /.header-menu -->
            <div class="header-actions flex items-center gap-3 md:gap-5">
                    ...
                    <div x-data="{dropdownProfile: false}" class="profile relative">
                        ...
                        >
                            ...
                            <div class="mt-4">
                                <ul class="space-y-2">
                                    <li>
                                        <a href="{{ route('order.index') }}" class="text-body hover:text-white text-xs font-medium">
                                            Мои заказы
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('profile.edit') }}" class="text-body hover:text-white text-xs font-medium">
                ...
                @else
                    <a href="{{ route('showLogin') }}" class="profile hidden xs:flex items-center">
                ...
                @endauth
                <a href="{{ route('wishlist.index') }}" class="flex items-center gap-3 text-pink hover:text-white">
                    ...
                    <div class="hidden sm:flex flex-col gap-2">
                        <span class="text-body text-xxs leading-none">{{ getTotalQuantity() }} шт.</span>
                        <span class="text-white text-xxs 2xl:text-xs font-bold !leading-none">{{ getTotalPrice() }} ₽</span>
                    </div>
                </a>
