    ...
    <div class="container">
        <div class="flex flex-wrap lg:flex-nowrap items-center">
            ...
            <div class="footer-copyright order-2 lg:order-1 basis-full lg:basis-1/3 mt-8 lg:mt-0">
                <div class="text-[#999] text-xxs xs:text-xs sm:text-sm text-center">CutCode, {{ now()->year }} © Все права защещены.
                </div>
...
<div id="mobileMenu" class="hidden bg-white fixed inset-0 z-[9999]">
	<div class="container">
		...
		<div class="mmenu-inner pt-10">
            ...
            @else
                <a href="{{ route('showLogin') }}" class="profile flex items-center mr-12">
			...
			<nav class="flex flex-col mt-8">
				<a href="{{ route('index') }}" class="self-start py-1 text-dark hover:text-pink text-md font-bold">Главная</a>
