...
<div class="product-card flex flex-col rounded-3xl bg-card">
    <a href="{{ route('product.show', $product) }}" class="product-card-photo overflow-hidden h-[320px] rounded-3xl">
    ...
    <div class="grow flex flex-col py-8 px-6">
        <h3 class="text-sm lg:text-md font-black"><a href="{{ route('product.show', $product) }}"
        ...
        <div class="mt-auto pt-6">
            ...
            <div class="flex flex-wrap items-center gap-4">
                @if (issetProductInCart($product->id))
                    <a href="{{ route('cart.index') }}" class="w-[56px] !h-[56px] !px-0 btn btn-pink">
